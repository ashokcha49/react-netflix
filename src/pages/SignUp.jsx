  ...
  return (
    ...
    <div className="max-w-[320px] mx-auto py-16">
        ...
        <form onSubmit={handleSubmit} className='flex flex-col'>
            ...
            <button className='bg-red-600 p-2 my-2 rounded'>Sign Up</button>
        </form>
        ...
        <p className='my-4 text-sm font-bold'><span className='text-gray-100/70 mr-2 font-normal'>Already subscribed to Netflix?</span>
        <Link to='/signin'>
         SignIn
         </Link>
         </p>
